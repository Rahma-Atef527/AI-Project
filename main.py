...
lr_grid = RandomizedSearchCV(LogisticRegression(max_iter=1000),
                             lr_params,
                             n_iter=5,
                             cv=3)
...
svm_grid = RandomizedSearchCV(SVC(class_weight='balanced'),
                              svm_params,
                              n_iter=5,
                              cv=3)
...
xgb_grid = RandomizedSearchCV(XGBClassifier(eval_metric='logloss'),
                              xgb_params,
                              n_iter=10,
                              cv=3)
